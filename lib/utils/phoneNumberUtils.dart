...
class Countries {
  static Map<String, String>? seperatePhoneAndDialCode(String? phoneWithCode) {
    if(phoneWithCode == null){
      return null;
    }
    Map<String, String> foundedCountry = {};
    for (var country in allCountryCode) {
      String dialCode = country["dial_code"].toString();
      print("dialcode: $dialCode");
      print("contains: ${phoneWithCode.contains(dialCode)}");
      if (phoneWithCode.contains(dialCode)) {
        foundedCountry = country;
        break;
      }
    }
    print("country $foundedCountry");
    if (foundedCountry.isNotEmpty) {
      var dialCode = phoneWithCode.substring(
        0,
        foundedCountry["dial_code"]!.length,
      );
      var newPhoneNumber = phoneWithCode.substring(
        foundedCountry["dial_code"]!.length,
      );
      print("code $dialCode and phone $newPhoneNumber");
      return {AppStrings.country_code: dialCode, AppStrings.phone_without_code: newPhoneNumber};
    }
  }

  static List<Map<String, String>> allCountryCode = [
